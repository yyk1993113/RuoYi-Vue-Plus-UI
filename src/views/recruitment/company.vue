...
function normalizeCompanyRow(row: any): any {
  return {
    ...
    oaSyncStatus: row.oaSyncStatus ?? row.oa_sync_status,
    oaSyncTime: row.oaSyncTime ?? row.oa_sync_time,
    oaSyncError: row.oaSyncError ?? row.oa_sync_error,
    oaSyncRetryCount: row.oaSyncRetryCount ?? row.oa_sync_retry_count ?? 0,
